package edu.kollozsolt.cards.controller;

import edu.kollozsolt.cards.constants.CardsConstants;
import edu.kollozsolt.cards.dto.CardsContactInfoDto;
import edu.kollozsolt.cards.dto.CardsDto;
import edu.kollozsolt.cards.dto.ErrorResponseDto;
import edu.kollozsolt.cards.dto.ResponseDto;
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to list Card details based on an mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
